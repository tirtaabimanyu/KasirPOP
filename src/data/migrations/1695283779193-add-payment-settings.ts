...
export class AddPaymentSettings1695283779193 implements MigrationInterface {
    name = 'AddPaymentSettings1695283779193'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payment_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "cash" boolean NOT NULL DEFAULT (1), "qris" boolean NOT NULL DEFAULT (0), "qrisImgUri" varchar)`);
