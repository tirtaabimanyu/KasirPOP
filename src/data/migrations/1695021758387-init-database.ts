...
export class InitDatabase1695021758387 implements MigrationInterface {
  name = "InitDatabase1695021758387";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "products" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "stock" integer NOT NULL, "isAlwaysInStock" boolean NOT NULL, "price" integer NOT NULL, "imgUri" varchar)`
    );
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL)`
    );
    await queryRunner.query(
      `CREATE TABLE "transactions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "created_at" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "total_price" integer NOT NULL, "products" text NOT NULL)`
    );
    await queryRunner.query(
